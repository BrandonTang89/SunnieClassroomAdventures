{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/brandon/SunnieClassroomAdventures";
  project_input_ref = "path:/home/brandon/SunnieClassroomAdventures";
  devenv_dotfile = "/home/brandon/SunnieClassroomAdventures/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/mnt/wslg/runtime-dir";
  devenv_runtime = "/mnt/wslg/runtime-dir/devenv-cd9d9dd";
  devenv_istesting = false;
  devenv_direnvrc_latest_version = 1;
  container_name = null;
  active_profiles = [
  ];
  hostname = "Brandon-nuc15";
  username = "brandon";
  git_root = "/home/brandon/SunnieClassroomAdventures";
  secretspec = null;
};
    in
    {
